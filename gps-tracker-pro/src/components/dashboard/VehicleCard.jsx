...
export default function VehicleCard({
  ...
  return (
    ...
    >
      ...
      {/* Quick info: fuel, distance, hours */}
      <div className="grid grid-cols-3 gap-2 mt-3 pt-3 border-t border-slate-600/20">
        <div className="text-center">
          ...
          <p className="text-[10px] text-slate-500">وقود</p>
        ...
        <div className="text-center">
          ...
          <p className="text-[10px] text-slate-500">مسافة</p>
        ...
        <div className="text-center">
          ...
          <p className="text-[10px] text-slate-500">ساعات</p>
